<?php
	...
	$level = new SQL\Level();
	$listLevel = $level->getLevelSearch($search);
	switch ($submit) {
		case 'search':
			break;
		case 'add':
						...
						<table class="table table-hover table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $value['levelAccess']; ?></td>
									<td><?php echo $value['memberEditLevel']; ?></td>
									<td><?php echo $value['datetimeEditLevel']; ?></td>
									<td>
										<a href="editlevel.php?id=<?php echo $value['levelID']; ?>">Sửa</a>
										<a href="deletelevel.php?id=<?php echo $value['levelID']; ?>" onclick='return confirm("Bạn chắc chắn muốn xóa bài này không?")'>Xóa</a>
									</td>
								</tr>
								<?php
										}
