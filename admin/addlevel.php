<?php
	...
	if (isset($_POST['save'])) {
		$list = $level->setLevel($levelName, $levelAccess);
		if ($listMember) {
			echo "<script>
		...
		<div class="container">
			...
			<div class="col-sm-10">
				<form method="post" action="" enctype="multipart/form-data">
					<div class="category">
						<input class="col-sm-12" type="text" name="level" value="" placeholder="Tên quyền truy cập...">
						<br/><br/>
						<textarea class="col-sm-12" name="access" placeholder="Giới hạn quyền truy cập..."></textarea>
					</div>
					<div class="bottom">
