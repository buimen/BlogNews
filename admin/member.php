<?php
	...
	$listMember = $member->getMemberSearch($search);
	switch ($submit) {
		case 'search':
			break;
		case 'add':
					...
					<form method="post" action="">
						<table class="table table-hover table-bordered">
							...
							<tbody>
								...
								?>
								<tr>
									<td><img src="../images/members/<?php echo $value['memberImage']; ?>"></td>
									<td><?php echo $value['memberUser']; ?></td>
									<td><?php echo $value['memberPass']; ?></td>
									<td><?php echo $value['levelName']; ?></td>
									<td><?php echo $value['memberEdit']; ?></td>
									<td><?php echo $value['datetimeEdit']; ?></td>
									<td>
										<a href="editmember.php?id=<?php echo $value['memberID']; ?>">Sửa</a>
										<a href="deletemember.php?id=<?php echo $value['memberID']; ?>" onclick='return confirm("Bạn chắc chắn muốn xóa bài này không?")'>Xóa</a>
									</td>
								</tr>
								<?php
										}
